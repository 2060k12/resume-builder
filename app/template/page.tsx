...
import EachSection from "./component/template1/EachSection";
import EachSubSection from "./component/template1/EachSubSection";

const page = () => {
  return (
    <>
      <div className=" bg-[#eeecec] w-screen h-screen flex justify-center items-center ">
        <div className="flex flex-col shadow-md w-[210mm] h-[297mm] bg-white scale-70 mx-auto origin-center p-10 gap-2">
          {/* header */}
          <div className=" mb-2">
            <div>
